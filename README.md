...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/image
```

A live public deployment of this template is available at [https://image.templates.workers.dev](https://image.templates.workers.dev)
